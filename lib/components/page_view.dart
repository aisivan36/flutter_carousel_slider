...
class PageControllerModified extends ScrollController {
  ...
  double? get page {
    ...
    final _PagePositionModified position =
        this.position as _PagePositionModified;
  ...
  void attach(ScrollPosition position) {
    ...
    final _PagePositionModified pagePosition =
        position as _PagePositionModified;
...
class _PagePositionModified extends ScrollPositionWithSingleContext
    implements PageMetricsModified {
...
class PageScrollPhysics extends ScrollPhysics {
  ...
  double _getPage(ScrollMetrics position) {
    if (position is _PagePositionModified) return position.page!;
...
class _PageViewModifiedState extends State<PageViewModified> {
    ...
    return NotificationListener<ScrollNotification>(
      onNotification: (ScrollNotification notification) {
        if (notification.depth == 0 &&
          ...
          final PageMetricsModified metrics =
              notification.metrics as PageMetricsModified;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<PageControllerModified>(
        'controller', widget.controller,
        showName: false));
